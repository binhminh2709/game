...
public class TabularPrinter {
  ...
  public TabularPrinter(OutputStream os, int[] width)
  ...
  public void printHeader(String[] header) {
    if (header.length != width.length) {
      throw new RuntimeException("Expect " + width.length + " column!!!");
    }
    printRowSeparator('*');
