...
public class AppInfo {
  ...
  public AppInfo() {
    ...
    for (int i = 0; i < tid.length; i++) {
      ...
      apptInfo
          .setThreadUserTime(Long.toString(mbean.getThreadUserTime(tid[i])));
      threadInfos.add(apptInfo);
    }
  }

  public ArrayList<AppThreadInfo> getThreadInfos() {
    return threadInfos;
  }

  public String getThreadStartedCount() {
    return threadStartedCount;
  }

  public void setThreadStartedCount(String threadStartedCount) {
    this.threadStartedCount = threadStartedCount;
  }

  public String getThreadPeakCount() {
    return threadPeakCount;
  }

  public void setThreadPeakCount(String threadPeakCount) {
  ...
  public String getThreadDeamonCount() {
    return threadDeamonCount;
  }

  public void setThreadDeamonCount(String threadDeamonCount) {
